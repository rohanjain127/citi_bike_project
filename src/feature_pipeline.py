...
# # ────────────────────────────────────────────────────────────────────────────────
# # 2 Load raw CSVs that you already placed in notebooks/data/citibike
# #    (adjust months=[…] if you need more than January)
# # ────────────────────────────────────────────────────────────────────────────────
# logger.info("Loading raw Citi Bike CSVs from local disk …")
# raw_rides = load_and_process_citibike_data_from_local(
#     year   = 2023,
#     months = [1],                       # ⇦ add months as needed, e.g. [1,2,3]
#     base_path = config.LOCAL_CITIBIKE_DATA_PATH,
# )
# logger.info(f"Loaded {len(raw_rides):,} raw rows")
...
# # ───────────────────────────────────────────────────────────────────────────────
# # 5 Create or fetch the Feature‑Group  (use **fs** consistently)
# # ───────────────────────────────────────────────────────────────────────────────
# # ───────────────────────────────────────────────────────────────────────────────
# # 5 Get‑or‑create the Feature‑Group  (single call, never returns None)
# # ───────────────────────────────────────────────────────────────────────────────
...
#     online_enabled = False,       # offline‑only FG
#     features     = fg_schema,
# )
...
# # ───────────────────────────────────────────────────────────────────────────────
# # 6 Make dtypes match the Feature‑Group schema and INSERT
# # ───────────────────────────────────────────────────────────────────────────────
# ts_data["pickup_location_id"] = ts_data["pickup_location_id"].astype(str)
# ts_data["rides"]              = ts_data["rides"].astype("int32")     # ← changed
...
# ────────────────────────────────────────────────────────────────────────────────
# 2 Load raw CSVs that you already placed in notebooks/data/citibike
#    (load all months you have: 2023 Jan–Dec, 2024 Jan–Dec, 2025 Jan–Mar)
# ────────────────────────────────────────────────────────────────────────────────
logger.info("Loading raw Citi Bike CSVs from local disk …")
all_raw = []
for year, months in [
...
# ────────────────────────────────────────────────────────────────────────────────
# 5 Create or fetch the Feature-Group
# ────────────────────────────────────────────────────────────────────────────────
from hsfs.feature import Feature
